...
const ROUTES: { path: string; changeFrequency: MetadataRoute.Sitemap[number]["changeFrequency"]; priority: number }[] = [
  ...
  { path: "/vault",              changeFrequency: "monthly", priority: 0.9 },
  { path: "/vault/features",     changeFrequency: "monthly", priority: 0.8 },
  { path: "/vault/security",     changeFrequency: "monthly", priority: 0.8 },
  { path: "/vault/integrations", changeFrequency: "monthly", priority: 0.7 },
  { path: "/vault/pricing",      changeFrequency: "monthly", priority: 0.8 },
