...
export default function CentilioPrivacyPolicy() {
  const sections = [
    ...
    { id: 'section2', title: '1. About this Privacy Notice' },
    { id: 'section3', title: '2. Third-Party Websites and Services' },
    { id: 'section4', title: '3. Types of Information We Collect' },
    { id: 'section5', title: '4. Information You Provide Us' },
    { id: 'section6', title: '5. Information Collected via Technology' },
    { id: 'section7', title: '6. Use and Processing of Personal Information' },
    { id: 'section8', title: '7. Use of Non-Personal Information' },
    { id: 'section9', title: '8. Sharing of Your Personal Information' },
    { id: 'section10',title: '9. Retention of Your Personal Information' },
    { id: 'section11',title: '10. How We Protect Your Personal Information' },
    { id: 'section12',title: '11. Your Choices' },
    { id: 'section13',title: '12. International Data Transfers' },
    { id: 'section14',title: '13. Children and Minors' },
    { id: 'section15',title: '14. Accessibility' },
    { id: 'section16',title: '15. Changes to our Privacy Notice' },
    { id: 'section17',title: '16. Contacting us' }
  ]
      ...
      <section className="py-12 md:py-16 bg-[#0E0F18]">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="lg:grid lg:grid-cols-12 lg:gap-12">
            {/* HOME US Sidebar - Hidden on mobile, visible on large screens */}
            ...
            <div className="lg:col-span-9">
              <div className="prose prose-invert max-w-none">
                ...
                <div id="section2" className="mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-xl md:text-2xl font-semibold text-white mb-3 md:mb-4">About us</h2>
                ...
                <div id="section1" className="mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-xl md:text-2xl font-semibold text-white mb-3 md:mb-4">1. About this Privacy Notice</h2>
                  <p className="text-gray-300 mb-3 md:mb-4 text-sm md:text-base md:leading-8" style={{ lineHeight: '24px' }}>
                    The following Privacy Notice outlines the procedures employed by Centilio, Inc. and its associated branches (referred to in various contexts as &quot;Centilio&quot;, &quot;we&quot;, &quot;our&quot;, or &quot;us&quot;) concerning the gathering, application, and release of your personal data. The data may be gathered through various means: use of our website <a href="/home" className="text-blue-400 hover:text-blue-300" target="_blank" rel="noopener noreferrer">(www.centilio.com)</a> , utilization of any of our products or services, interaction with the Centilio software-as-a-service product (&quot;SaaS&quot;), usage of the Centilio mobile application (&quot;App&quot;), account creation, interactions with us, opting to receive SMS messages, or interaction with any other websites, pages, or content we own or provide (collectively referred to as &quot;Services&quot;).
                  </p>
                  <p className="text-gray-300 text-sm md:text-base md:leading-8" style={{ lineHeight: '24px' }}>
                    If you do not agree with this Privacy Notice or fail to adhere to the outlined provisions, we recommend refraining from using our Services. By accepting this Privacy Notice and utilizing our Services, you consent to our data gathering, storage, usage, and dissemination practices as outlined in both this Privacy Notice and our Cookie Notice, which can be found at <a href="/cookies" className="text-blue-400 hover:text-blue-300 " target="_blank" rel="noopener noreferrer">https://www.centilio.com/cookie-notice/</a> . The use of our website and app is regulated by Centilio&apos;s Terms of Service, accessible at <a href="/terms" className="text-blue-400 hover:text-blue-300 " target="_blank" rel="noopener noreferrer" > https://www.centilio.com/terms-of-use/</a>.
                  </p>
                </div>
                {/* Section 3 - Third-Party Websites and Services */}
                <div id="section3" className="mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-xl md:text-2xl font-semibold text-white mb-3 md:mb-4">2. Third-Party Websites and Services</h2>
                  <p className="text-gray-300 mb-3 md:mb-4 text-sm md:text-base md:leading-8" style={{ lineHeight: '24px' }}>
                ...
                <div id="section4" className="mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-xl md:text-2xl font-semibold text-white mb-3 md:mb-4">3. Types of Information We Collect</h2>
                  <p className="text-gray-300 mb-3 md:mb-4 text-sm md:text-base md:leading-8" style={{ lineHeight: '24px' }}>
                  ...
                  {/* Data Collection Table - Scrollable on mobile only */}
                  <div className="overflow-x-auto lg:overflow-x-visible mt-6 md:mt-8">
                    <table className="w-full border-collapse min-w-[800px] lg:min-w-full" style={{ border: '1px solid #5A5858' }}>
                      <thead>
                        <tr style={{ backgroundColor: 'rgba(255, 255, 255, 0.2)' }}>
                          <th className="px-4 py-3 text-center text-white font-semibold" style={{ border: '1px solid #5A5858' }}>Context</th>
                          <th className="px-4 py-3 text-center text-white font-semibold" style={{ border: '1px solid #5A5858' }}>Types of data</th>
                          <th className="px-4 py-3 text-center text-white font-semibold" style={{ border: '1px solid #5A5858' }}>Primary purpose for collection and use of data</th>
                        </tr>
                      </thead>
                      <tbody className="text-gray-300" style={{ lineHeight: '28px' }}>
                       <tr style={{ backgroundColor: 'rgba(255, 255, 255, 0.2)' }}>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>Client information</td>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>We collect the name, username, and contact information, of our clients and their employees with whom we may interact.</td>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>We have a legitimate interest in contacting our clients and communicating with them concerning normal business administration such as projects, services, and billing</td>
                        </tr>
                        <tr style={{ backgroundColor: 'rgba(255, 255, 255, 0.2)' }}>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>Client user account information</td>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>We collect personal information from our clients when they create an account to access and use the Services. or request certain free Services from our Website. This information could include business contact information such as name, email address, IP address, geolocation, title, company information, industry, and password for our Services.</td>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>We have a legitimate interest in providing account-related functionalities to our users, monitoring account log-ins, and detecting potential fraudulent logins or account misuse. Additionally, we use this information to fulfill our contract to provide you with Services.</td>
                        </tr>
                       <tr style={{ backgroundColor: 'rgba(255, 255, 255, 0.2)' }}>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>28-day free trial and/or free e-sign account</td>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>We collect personal information from our clients when they request a 28-day free trial or free e-sign account from our Website. This Personal Information includes name, IP address, geolocation, and business contact information such as email address, title, and password for your Centilio account. Clients may also provide a credit card number or other billing details.</td>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>We have a legitimate interest in providing account-related functionalities to our users, monitoring account log-ins, and detecting potential fraudulent logins or account misuse. Additionally, we use this information to facilitate ease of account creation if a user chooses to purchase the service during or immediately following a free trial period.</td>
                        </tr>
                       <tr style={{ backgroundColor: 'rgba(255, 255, 255, 0.2)' }}>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>Contact information of vendors</td>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>Users of our Service may ask their vendors or service providers to submit company and security-related information on our platform (e.g., to complete a security questionnaire). When a user invites a vendor we collect the name and email address of the vendor.</td>
                        ...
                        <tr style={{ backgroundColor: 'rgba(255, 255, 255, 0.2)' }}>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>Account information — vendors</td>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>We collect personal information from vendors when they create an account to access and use the Services or request certain free Services from our Website.</td>
                        ...
                        <tr style={{ backgroundColor: 'rgba(255, 255, 255, 0.2)' }}>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>Cookies and first-party tracking</td>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>We use pixels, beacons, cookies, and clear GIFs. &quot;Cookies&quot; are small pieces of information that a website sends to a computer&apos;s hard drive while a website is viewed. See our Cookie Notice for further information.</td>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>We have a legitimate interest in providing account-related functionalities to our vendor users, monitoring account log-ins, and detecting potential fraudulent logins or account misuse. Additionally, in some cases, we use this information to fulfill our contract to provide vendor-users with Services.</td>
                        </tr>
                      <tr style={{ backgroundColor: 'rgba(255, 255, 255, 0.2)' }}>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>Cookies and third-party tracking</td>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>We participate in behavior-based advertising, this means that a third party uses technology (e.g., a cookie) to collect information about your use of our website so that they can provide advertising about products and services tailored to your interests on our website, or on other websites. To learn more about our third-party partners, please read their respective privacy policies. Google Analytics is an analytics service provided by Google LLC. (US).: Privacy Disclosures Policy How Google uses information from sites or apps that use our services Safeguarding your data You may opt-out of Google Analytics for display advertising or customize Google display network ads by managing your privacy controls on Google&apos;s website. Looker Analytics is a business intelligence tool that we use and this service is provided by Google LLC (US): Privacy Policy – Privacy & Terms – Google.</td>
                       ...
                       <tr style={{ backgroundColor: 'rgba(255, 255, 255, 0.2)' }}>
                        ...
                        <tr style={{ backgroundColor: 'rgba(255, 255, 255, 0.2)' }}>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>Employment</td>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>When you apply for a job posting or become an employee or contractor, we collect information necessary to process your application or to retain you as an employee or contractor. This may include, among other things, your Social Security Number, diversity or demographic information, including race or ethnicity, gender or gender identity, and veteran or disability status. Providing this information is required for employment.</td>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>We use information about current employees to perform our contract of employment or the anticipation of a contract of employment with you. In some contexts, we are also required by law to collect information about our employees. We also have a legitimate interest in using your information to have efficient staffing and workforce operations and provide the Website, the Services, and App to our clients</td>
                        </tr>
                        <tr style={{ backgroundColor: 'rgba(255, 255, 255, 0.2)' }}>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>Feedback/Support</td>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>We collect Personal Information from you contained in any inquiry you submit to us regarding our Website or Services, such as completing our online forms, calling, or emailing for the purposes of general inquiries, support requests, or to report an issue. When you communicate with us over the phone or over a video-call platform, your calls may be recorded and sent to you as a support measure. These calls may also be analyzed for training, quality control, and for sales and marketing purposes by Centilio. During such calls we will notify you of the recording via either voice prompt or script. We may collect sensory information such as audio and visual image.</td>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>We have a legitimate interest in receiving, and acting upon, your feedback, issues, or inquiries.</td>
                        </tr>
                        <tr style={{ backgroundColor: 'rgba(255, 255, 255, 0.2)' }}>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>Mailing list</td>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>When you sign up for one of our mailing lists, we collect your email address along with your first and last name.</td>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>We share information about our products and services with individuals that consent to receive such information. We also have a legitimate interest in sharing information about our products or services.</td>
                        </tr>
                        <tr style={{ backgroundColor: 'rgba(255, 255, 255, 0.2)' }}>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>Marketing data</td>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>When you subscribe to one of our mailing list(s), we collect your email address along with your first and last name.</td>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>We share information about our products and services with individuals that consent to receive such information. We also have a legitimate interest in sharing information about our products or services.</td>
                        </tr>
                        <tr style={{ backgroundColor: 'rgba(255, 255, 255, 0.2)' }}>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>Mobile device data</td>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>We collect information from your mobile device when visiting our Website. Such information may include operating system type and/or mobile device model, browser type, domain, and other system settings, the language your system uses and the country and time zone of your device, geo-location, unique device identifier and/or other device identifier, mobile phone carrier identification, and device software platform and firmware information.</td>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>We have a legitimate interest in identifying unique visitors, and in understanding how users interact with us on their mobile devices.</td>
                        </tr>
                        <tr style={{ backgroundColor: 'rgba(255, 255, 255, 0.2)' }}>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>Order placement</td>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>Subsequent to Service enrollment (where we collect name, email and phone number, job role, company name and size), to place an order, we collect billing address, and credit or debit card details.</td>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>We use your information to perform our contract to provide you with products or services.</td>
                        </tr>
                        <tr style={{ backgroundColor: 'rgba(255, 255, 255, 0.2)' }}>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>Social Media Connectors</td>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>Our Website uses social media connectors. They are social media buttons, such as LinkedIn, Facebook, Twitter, Instagram and YouTube, you see on our Website that allow you to connect and learn more about us and interact with us, our users and marketing partners.</td>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>We may engage in behavior-based advertising, capturing website and mobile application analytics and engaging third parties to assist with providing services that may be of interest to you.</td>
                        </tr>
                        <tr style={{ backgroundColor: 'rgba(255, 255, 255, 0.2)' }}>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>Transactional Data/Event Data</td>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>Names and email addresses of parties to a transaction, subject line, history of actions individuals take related to a transaction (i.e. sign and forward features) and personal information about those individuals or their devices, such as name, IP address, email address and other authentication methods.</td>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>We use this information to fulfill our contractual duties to our Customers. We also have a legitimate interest in creating and maintaining an audit trail proving the authenticity and legality of signatures and documents created by Centilio.</td>
                        </tr>
                        <tr style={{ backgroundColor: 'rgba(255, 255, 255, 0.2)' }}>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>Surveys</td>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>When you participate in a survey we collect information that you provide through the survey. If the survey is provided by a third party service provider, the third party&apos;s privacy policy applies to the collection, use, and disclosure of your information. Participation in any such surveys is completely voluntary and you therefore have a choice whether to disclose such information.</td>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>We have a legitimate interest in understanding your opinions, and collecting information relevant to our organization.</td>
                        </tr>
                        <tr style={{ backgroundColor: 'rgba(255, 255, 255, 0.2)' }}>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>Usage Data</td>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>Such as referring and exit pages and URLs, domain names, landing pages and content viewed and the order of those pages, the amount of time spent on particular pages, the frequency of your use of our Services and other related information.</td>
                        ...
                        <tr style={{ backgroundColor: 'rgba(255, 255, 255, 0.2)' }}>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>Website interactions</td>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>We use technology to monitor how you interact with our website. This may include which links you click on, or information that you type into our online forms. This may also include information about your device or browser.</td>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>We have a legitimate interest in understanding how you interact with our website to better improve it, and to understand your preferences and interests in order to select offerings that you might find most useful. We also have a legitimate interest in detecting and preventing fraud.</td>
                        </tr>
                        <tr style={{ backgroundColor: 'rgba(255, 255, 255, 0.2)' }}>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>Web logs</td>
                          <td className="px-4 py-3 align-center" style={{ border: '1px solid #5A5858' }}>We collect information, including your browser type, operating system, Internet Protocol (IP) address (a number that is automatically assigned to a computer when the Internet is used), domain name, click-activity, referring website, and/or a date/time stamp for visitors.</td>
                ...
                <div id="section5" className="mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-xl md:text-2xl font-semibold text-white mb-3 md:mb-4">4. Information You Provide Us</h2>
                ...
                <div id="section6" className="mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-xl md:text-2xl font-semibold text-white mb-3 md:mb-4">5. Information Collected via Technology</h2>
                    <div className="text-gray-300 space-y-2 ml-3 md:ml-4 text-sm md:text-base" style={{ lineHeight: '22px' }}>
                ...
                <div id="section7" className="mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-xl md:text-2xl font-semibold text-white mb-3 md:mb-4">6. Use and Processing of Personal Information</h2>
                  <p className="text-gray-300 mb-3 md:mb-4 text-sm md:text-base md:leading-8" style={{ lineHeight: '24px' }}>
                ...
                <div id="section8" className="mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-xl md:text-2xl font-semibold text-white mb-3 md:mb-4">7. Use of Non-Personal Information</h2>
                  <p className="text-gray-300 text-sm md:text-base md:leading-8" style={{ lineHeight: '24px' }}>
                ...
                <div id="section9" className="mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-xl md:text-2xl font-semibold text-white mb-3 md:mb-4">8. Sharing of Your Personal Information</h2>
                  <p className="text-gray-300 mb-3 md:mb-4 text-sm md:text-base md:leading-8" style={{ lineHeight: '24px' }}>
                ...
                <div id="section10" className="mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-xl md:text-2xl font-semibold text-white mb-3 md:mb-4">9. Retention of Your Personal Information</h2>
                  <p className="text-gray-300 text-sm md:text-base md:leading-8" style={{ lineHeight: '24px' }}>
                ...
                <div id="section11" className="mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-xl md:text-2xl font-semibold text-white mb-3 md:mb-4">10. How We Protect Your Personal Information</h2>
                  <p className="text-gray-300 mb-3 md:mb-4 text-sm md:text-base md:leading-8" style={{ lineHeight: '24px' }}>
                ...
                <div id="section12" className="mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-xl md:text-2xl font-semibold text-white mb-3 md:mb-4">11. Your Choices</h2>
                  <p className="text-gray-300 mb-3 md:mb-4 text-sm md:text-base md:leading-8" style={{ lineHeight: '24px' }}>
                ...
                <div id="section13" className="mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-xl md:text-2xl font-semibold text-white mb-3 md:mb-4">12. International Data Transfers</h2>
                  <p className="text-gray-300 text-sm md:text-base md:leading-8" style={{ lineHeight: '24px' }}>
                ...
                <div id="section14" className="mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-xl md:text-2xl font-semibold text-white mb-3 md:mb-4">13. Children and Minors</h2>
                  <p className="text-gray-300 text-sm md:text-base md:leading-8" style={{ lineHeight: '24px' }}>
                ...
                <div id="section15" className="mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-xl md:text-2xl font-semibold text-white mb-3 md:mb-4">14. Accessibility</h2>
                  <p className="text-gray-300 text-sm md:text-base md:leading-8" style={{ lineHeight: '24px' }}>
                ...
                <div id="section16" className="mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-xl md:text-2xl font-semibold text-white mb-3 md:mb-4">15. Changes to our Privacy Notice</h2>
                  <p className="text-gray-300 text-sm md:text-base md:leading-8" style={{ lineHeight: '24px' }}>
                ...
                <div id="section17" className="mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-xl md:text-2xl font-semibold text-white mb-3 md:mb-4">16. Contacting us</h2>
                  <p className="text-gray-300 text-sm md:text-base md:leading-8" style={{ lineHeight: '24px' }}>
