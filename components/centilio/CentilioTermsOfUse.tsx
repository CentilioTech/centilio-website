...
export default function CentilioTermsOfUse() {
  const sections = [
    // Title Bar //
    { id: 'section1', title: '1. Acceptance of Terms of Service' },
    { id: 'section2', title: '2. Eligibility' },
    { id: 'section3', title: '3. Registration' },
    { id: 'section4', title: '4. The Services' },
    { id: 'section5', title: '5. Customer Content' },
    { id: 'section6', title: '6. Third Party Services' },
    { id: 'section7', title: '7. Payments and Billing' },
    { id: 'section8', title: '8. Copyright Policy' },
    { id: 'section9', title: '9. Termination' },
    { id: 'section10', title:'10. Warranty Disclaimer' },
    { id: 'section11', title:'11. Indemnification' },
    { id: 'section12', title:'12. Limitation of Liability' },
    { id: 'section13', title:'13. Arbitration' },
    { id: 'section14', title:'14. Governing Law and Jurisdiction' },
    { id: 'section15', title:'15. Modification' },
    { id: 'section16', title:'16. Miscellaneous' },
    { id: 'section17', title:'17. Force Majeure' },
    { id: 'section18', title:'18. Assignment' },
    { id: 'section19', title:'19. Agency' },
    { id: 'section20', title:'20. Notices' },
    { id: 'section21', title:'21. No Waiver' },
    { id: 'section22', title:'22. Headings; Interpretation' },
    { id: 'section23', title:'23. Publicity' },
    { id: 'section24', title:'24. Contact' }
  ]
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative py-8 sm:py-12 md:py-16 lg:py-20 overflow-hidden bg-[#0E0F18]">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-3 sm:px-4 md:px-6 text-center">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white">Terms of Use</h1>
        </div>
      </section>

      {/* Main Content */}
      <section className="py-8 sm:py-12 md:py-16 bg-[#0E0F18]">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6">
          <div className="lg:grid lg:grid-cols-12 lg:gap-12">
            {/* Title Bar Sidebar - Hidden on mobile, visible on large screens */}
            ...
            <div className="lg:col-span-9">
              <div className="prose prose-invert max-w-none">
                <p className="text-gray-300 mb-4 sm:mb-6 md:mb-8 text-xs sm:text-sm md:text-base md:leading-8" style={{ lineHeight: '22px' }}>
                ...
                <div id="section1" className="mb-6 sm:mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-white mb-2 sm:mb-3 md:mb-4">1. Acceptance of Terms of Service</h2>
                  <p className="text-gray-300 mb-2 sm:mb-3 md:mb-4 text-xs sm:text-sm md:text-base md:leading-8" style={{ lineHeight: '20px' }}>
                  ...
                  <p className="text-gray-300 text-xs sm:text-sm md:text-base md:leading-8" style={{ lineHeight: '20px' }}>
                ...
                <div id="section2" className="mb-6 sm:mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-white mb-2 sm:mb-3 md:mb-4">2. Eligibility</h2>
                  <p className="text-gray-300 text-xs sm:text-sm md:text-base md:leading-8" style={{ lineHeight: '20px' }}>
                ...
                <div id="section3" className="mb-6 sm:mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-white mb-2 sm:mb-3 md:mb-4">3. Registration</h2>
                  <p className="text-gray-300 text-xs sm:text-sm md:text-base md:leading-8" style={{ lineHeight: '20px' }}>
                ...
                <div id="section4" className="mb-6 sm:mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-white mb-2 sm:mb-3 md:mb-4">4. The Services</h2>
                  <p className="text-gray-300 mb-2 sm:mb-3 md:mb-4 text-xs sm:text-sm md:text-base md:leading-8" style={{ lineHeight: '20px' }}>
                ...
                <div id="section5" className="mb-6 sm:mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-white mb-2 sm:mb-3 md:mb-4">5. Customer Content</h2>
                  <p className="text-gray-300 mb-2 sm:mb-3 md:mb-4 text-xs sm:text-sm md:text-base md:leading-8" style={{ lineHeight: '20px' }}>
                ...
                <div id="section6" className="mb-6 sm:mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-white mb-2 sm:mb-3 md:mb-4">6. Third Party Services</h2>
                  <p className="text-gray-300 text-xs sm:text-sm md:text-base md:leading-8" style={{ lineHeight: '20px' }}>
                ...
                <div id="section7" className="mb-6 sm:mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-white mb-2 sm:mb-3 md:mb-4">7. Payments and Billing</h2>
                  <p className="text-gray-300 mb-2 sm:mb-3 md:mb-4 text-xs sm:text-sm md:text-base md:leading-8" style={{ lineHeight: '20px' }}>
                ...
                <div id="section8" className="mb-6 sm:mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-white mb-2 sm:mb-3 md:mb-4">8. Copyright Policy</h2>
                  <p className="text-gray-300 mb-2 sm:mb-3 md:mb-4 text-xs sm:text-sm md:text-base md:leading-8" style={{ lineHeight: '20px' }}>
                    a. CENTILIO has adopted the following general policy toward copyright infringement in accordance with the Digital Millennium Copyright Act <a href="https://www.copyright.gov/legislation/dmca.pdf" className="text-blue-400 hover:text-blue-300 " target="_blank">(http://lcweb.loc.gov/copyright/legislation/dmca.pdf)</a> . The address of the Designated Agent to Receive Notification of Claimed Infringement (&quot;Designated Agent&quot;) is listed at the end of this paragraph.
                  </p>
                  <p className="text-gray-300 mb-2 sm:mb-3 md:mb-4 text-xs sm:text-sm md:text-base md:leading-8" style={{ lineHeight: '20px' }}>
                ...
                <div id="section9" className="mb-6 sm:mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-white mb-2 sm:mb-3 md:mb-4">9. Termination</h2>
                  <p className="text-gray-300 mb-2 sm:mb-3 md:mb-4 text-xs sm:text-sm md:text-base md:leading-8" style={{ lineHeight: '20px' }}>
                ...
                <div id="section10" className="mb-6 sm:mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-white mb-2 sm:mb-3 md:mb-4">10. Warranty Disclaimer</h2>
                  <p className="text-gray-300 mb-2 sm:mb-3 md:mb-4 text-xs sm:text-sm md:text-base md:leading-8" style={{ lineHeight: '20px' }}>
                ...
                <div id="section11" className="mb-6 sm:mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-white mb-2 sm:mb-3 md:mb-4">11. Indemnification</h2>
                  <p className="text-gray-300 text-xs sm:text-sm md:text-base md:leading-8" style={{ lineHeight: '20px' }}>
                ...
                <div id="section12" className="mb-6 sm:mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-white mb-2 sm:mb-3 md:mb-4">12. Limitation of Liability</h2>
                  <p className="text-gray-300 text-xs sm:text-sm md:text-base md:leading-8" style={{ lineHeight: '20px' }}>
                ...
                <div id="section13" className="mb-6 sm:mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-white mb-2 sm:mb-3 md:mb-4">13. Arbitration</h2>
                  <p className="text-gray-300 mb-2 sm:mb-3 md:mb-4 text-xs sm:text-sm md:text-base md:leading-8" style={{ lineHeight: '20px' }}>
                    a. All disputes between you and centilio (whether or not such dispute involves a third party) with regard to your relationship with centilio, including without limitation disputes related to these terms of service, your use of the services, and/or rights of privacy and/or publicity, will be resolved by binding, individual arbitration in new york, new york under the streamlined arbitration rules and procedures (&quot;rules&quot;) of jams, inc. (&quot;ams&quot;) Then in effect, by one commercial arbitrator with substantial experience in resolving intellectual property and commercial contract disputes, who shall be selected from the appropriate list of jams arbitrators in accordance with such rules, and you and centilio hereby expressly waive trial by jury. Discovery and rights to appeal in arbitration are generally more limited than in a lawsuit, and other rights that you and centilio would have in court may not be available in arbitration.
                  </p>
                  <p className="text-gray-300 mb-2 sm:mb-3 md:mb-4 text-xs sm:text-sm md:text-base md:leading-8" style={{ lineHeight: '20px' }}>
                ...
                <div id="section14" className="mb-6 sm:mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-white mb-2 sm:mb-3 md:mb-4">14. Governing Law and Jurisdiction</h2>
                  <p className="text-gray-300 text-xs sm:text-sm md:text-base md:leading-8" style={{ lineHeight: '20px' }}>
                ...
                <div id="section15" className="mb-6 sm:mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-white mb-2 sm:mb-3 md:mb-4">15. Modification</h2>
                  <p className="text-gray-300 text-xs sm:text-sm md:text-base md:leading-8" style={{ lineHeight: '20px' }}>
                ...
                <div id="section16" className="mb-6 sm:mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-white mb-2 sm:mb-3 md:mb-4">16. Miscellaneous</h2>
                  <p className="text-gray-300 text-xs sm:text-sm md:text-base md:leading-8" style={{ lineHeight: '20px' }}>
                ...
                <div id="section17" className="mb-6 sm:mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-white mb-2 sm:mb-3 md:mb-4">17. Force Majeure</h2>
                  <p className="text-gray-300 text-xs sm:text-sm md:text-base md:leading-8" style={{ lineHeight: '20px' }}>
                ...
                <div id="section18" className="mb-6 sm:mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-white mb-2 sm:mb-3 md:mb-4">18. Assignment</h2>
                  <p className="text-gray-300 text-xs sm:text-sm md:text-base md:leading-8" style={{ lineHeight: '20px' }}>
                ...
                {/* Section 19 - Agency */}
                <div id="section19" className="mb-6 sm:mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-white mb-2 sm:mb-3 md:mb-4">19. Agency</h2>
                  <p className="text-gray-300 text-xs sm:text-sm md:text-base md:leading-8" style={{ lineHeight: '20px' }}>
                ...
                {/* Section 20 - Notices */}
                <div id="section20" className="mb-6 sm:mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-white mb-2 sm:mb-3 md:mb-4">20. Notices</h2>
                  <p className="text-gray-300 text-xs sm:text-sm md:text-base md:leading-8" style={{ lineHeight: '20px' }}>
                ...
                <div id="section21" className="mb-6 sm:mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-white mb-2 sm:mb-3 md:mb-4">21. No Waiver</h2>
                  <p className="text-gray-300 text-xs sm:text-sm md:text-base md:leading-8" style={{ lineHeight: '20px' }}>
                ...
                <div id="section22" className="mb-6 sm:mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-white mb-2 sm:mb-3 md:mb-4">22. Headings; Interpretation</h2>
                  <p className="text-gray-300 text-xs sm:text-sm md:text-base md:leading-8" style={{ lineHeight: '20px' }}>
                ...
                <div id="section23" className="mb-6 sm:mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-white mb-2 sm:mb-3 md:mb-4">23. Publicity</h2>
                  <p className="text-gray-300 text-xs sm:text-sm md:text-base md:leading-8" style={{ lineHeight: '20px' }}>
                ...
                {/* Section 24 - Contact */}
                <div id="section24" className="mb-6 sm:mb-8 md:mb-12 scroll-mt-32">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-white mb-2 sm:mb-3 md:mb-4">24. Contact</h2>
                  <p className="text-gray-300 text-xs sm:text-sm md:text-base md:leading-8" style={{ lineHeight: '20px' }}>
