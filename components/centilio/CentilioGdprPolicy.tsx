...
export default function CentilioGdprPolicy() {
  const sections = [
    { id: 'section1', title: 'Data Controller and Data Protection Officer' },
    { id: 'section2', title: 'Lawful Basis for Processing' },
    { id: 'section3', title: 'Data Subject Rights' },
    { id: 'section4', title: 'Data Retention' },
    { id: 'section5', title: 'Data Security' },
    { id: 'section6', title: 'Data Breach Notification' },
    { id: 'section7', title: 'International Data Transfers' },
    { id: 'section8', title: 'Third-Party Processors' },
    { id: 'section9', title: 'Privacy by Design' },
    { id: 'section10', title: 'Training and Awareness' },
    { id: 'section11', title: 'Contact Us' }
  ]
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-20 overflow-hidden bg-[#0E0F18]">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          <h1 className="text-5xl font-bold text-white">GDPR Policy</h1>
        </div>
      </section>
            ...
            <div className="col-span-9">
              <div className="prose prose-invert max-w-none">
                ...
                <div id="section1" className="mb-12">
                  <h2 className="text-2xl font-semibold text-white mb-4">Data Controller and Data Protection Officer</h2>
                ...
                <div id="section2" className="mb-12">
                  <h2 className="text-2xl font-semibold text-white mb-4">Lawful Basis for Processing</h2>
                  <p className="text-gray-300 mb-4" style={{ lineHeight: '32px' }}>
                ...
                <div id="section3" className="mb-12">
                  <h2 className="text-2xl font-semibold text-white mb-4">Data Subject Rights</h2>
                  <p className="text-gray-300 mb-4" style={{ lineHeight: '32px' }}>
                ...
                <div id="section8" className="mb-12">
                  <h2 className="text-2xl font-semibold text-white mb-4">Third-Party Processors</h2>
                  <p className="text-gray-300" style={{ lineHeight: '32px' }}>
                ...
                <div id="section9" className="mb-12">
                  <h2 className="text-2xl font-semibold text-white mb-4">Privacy by Design</h2>
                  <p className="text-gray-300" style={{ lineHeight: '32px' }}>
                ...
                <div id="section10" className="mb-12">
                  <h2 className="text-2xl font-semibold text-white mb-4">Training and Awareness</h2>
                  <p className="text-gray-300" style={{ lineHeight: '32px' }}>
