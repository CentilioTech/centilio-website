    ...
    <footer className="bg-[#181A1E] border-t border-[#2A3142] py-8 sm:py-12 lg:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex items-center justify-center sm:justify-end pt-6 sm:pt-8 border-t border-[#2A3142] gap-4 sm:gap-6">
          <a href="https://www.facebook.com/profile.php?id=61559910162873" className="hover:opacity-70 transition-opacity" target="_blank"
          ...
          <a href="https://www.instagram.com/centilioofficial/" className="hover:opacity-70 transition-opacity" target="_blank"
                rel="noopener noreferrer">
            <Image
          ...
          <a href="https://www.youtube.com/channel/UCbeEVRQaWtUFEuqD1E2BN0w" className="hover:opacity-70 transition-opacity" target="_blank"
                rel="noopener noreferrer">
            <Image
          ...
          <a href="https://www.linkedin.com/company/centilio2022/posts/?feedView=all" className="hover:opacity-70 transition-opacity" target="_blank"
                rel="noopener noreferrer">
            <Image
          ...
          <a href="https://x.com/CentilioSign" className="hover:opacity-70 transition-opacity" target="_blank"
                rel="noopener noreferrer">
            <Image
