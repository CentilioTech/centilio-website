    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#181A1E] border-b border-[#2A3142] transition-all duration-300">
      <nav className={`w-full mx-auto px-4 sm:px-6 md:px-20 flex items-center justify-between transition-all duration-300 ${
        ...
        <div className="hidden md:flex items-center gap-6 lg:gap-8">
          <Link href="/seobot-features" className="text-white hover:text-gray-300 transition-colors text-sm lg:text-base">Features</Link>
          <Link href="/seobot-integrations" className="text-white hover:text-gray-300 transition-colors text-sm lg:text-base">Integrations</Link>
          <Link href="/pricing" className="text-white hover:text-gray-300 transition-colors text-sm lg:text-base">Pricing</Link>
          <Link href="/seobot-contact" className="text-white hover:text-gray-300 transition-colors text-sm lg:text-base">Contact Us</Link>
        </div>
