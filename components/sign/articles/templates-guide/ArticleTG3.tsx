...
export default function ArticleTG3() {
            ...
            <main className="flex-1">
              <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-6 lg:p-12">
                ...
                <div className="flex items-center gap-2 mb-8 text-sm text-white/50">
                  ...
                  <span>›</span>
                  <span>How do I create my own custom template?</span>
                </div>
                ...
                <div className="prose prose-invert max-w-none">
                  ...
                  <ol className="space-y-3 mb-8 text-white/80 text-lg leading-relaxed list-decimal ml-6">
                    <li><strong className="text-white">Upload a document</strong> that you want to turn into a template</li>
                    <li><strong className="text-white">Configure all the signature fields</strong> and recipient roles</li>
                    <li><strong className="text-white">Instead of clicking &apos;Send&apos;,</strong> look for the &apos;Save as Template&apos; option</li>
                    <li><strong className="text-white">Give your template a clear, descriptive name</strong></li>
                  ...
                  <div className="bg-[#4285F4]/10 border border-[#4285F4]/30 rounded-xl p-6 mb-8">
                    <p className="text-white/90 text-lg italic mb-0">
                      <strong className="text-white"><Image src="/images/guide svgs/quick_tip.svg" alt="Tip" width={20} height={20} className="inline-block mr-2" />Best Practice:</strong> Create templates for any document type you send more than three times. This saves significant time in the long run.
                    </p>
                  </div>
