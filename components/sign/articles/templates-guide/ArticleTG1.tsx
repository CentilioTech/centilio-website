...
export default function ArticleTG1() {
            ...
            <main className="flex-1">
              <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-6 lg:p-12">
                ...
                <div className="flex items-center gap-2 mb-8 text-sm text-white/50">
                  ...
                  <span>›</span>
                  <span>What pre-built templates are available in Centilio Sign?</span>
                </div>
                ...
                <div className="prose prose-invert max-w-none">
                  <p className="text-white/80 text-lg leading-relaxed mb-6">
                    Centilio Sign provides ready-to-use templates for common business documents:
                  </p>

                  <ul className="space-y-3 mb-8 text-white/80 text-lg leading-relaxed list-disc ml-6">
                    <li><strong className="text-white">Non-Disclosure Agreements (NDAs)</strong></li>
                    <li><strong className="text-white">Service Contracts</strong></li>
                    <li><strong className="text-white">Employment Agreements</strong></li>
                    <li><strong className="text-white">Vendor Agreements</strong></li>
                    <li><strong className="text-white">Sales Contracts</strong></li>
                    <li><strong className="text-white">Lease Agreements</strong></li>
                    <li><strong className="text-white">Partnership Agreements</strong></li>
                  </ul>
                  ...
                  <div className="bg-[#4285F4]/10 border border-[#4285F4]/30 rounded-xl p-6 mb-8">
                    <p className="text-white/90 text-lg italic mb-0">
                      <strong className="text-white">📋 Template Library:</strong> New templates are added regularly based on user feedback and industry standards.
                    </p>
                  </div>
                </div>
