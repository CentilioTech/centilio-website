...
export default function ArticleAG2() {
            ...
            <main className="flex-1">
              <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-6 lg:p-12">
                ...
                <div className="flex items-center gap-2 mb-8 text-sm text-white/50">
                  ...
                  <span>›</span>
                  <span>How do I add or remove users from my organization?</span>
                </div>
                ...
                <div className="prose prose-invert max-w-none">
                  ...
                  <h3 className="text-[#EA4335] text-2xl font-bold mt-8 mb-4">Adding Users to Your Organization</h3>

                  <p className="text-white/80 text-lg leading-relaxed mb-6">
                    <strong className="text-white">Step 1: Navigate to Organization Members</strong>
                  </p>
                  <ul className="space-y-3 mb-8 text-white/80 text-lg leading-relaxed list-disc ml-6">
                    <li>Click Organization from the left sidebar</li>
                    <li>Scroll to the Organization Members section</li>
                  </ul>

                  <p className="text-white/80 text-lg leading-relaxed mb-6">
                    <strong className="text-white">Step 2: Invite New Member</strong>
                  </p>
                  <ul className="space-y-3 mb-8 text-white/80 text-lg leading-relaxed list-disc ml-6">
                    ...
                    <li>Fill in the required details:
                      <ul className="space-y-3 mt-3 ml-6">
                        ...
                        <li>Role (required): Select Super Admin or Admin</li>
                      </ul>
                    </li>
                  </ul>

                  <p className="text-white/80 text-lg leading-relaxed mb-6">
                    <strong className="text-white">Step 3: Send Invitation</strong>
                  </p>
                  <ul className="space-y-3 mb-8 text-white/80 text-lg leading-relaxed list-disc ml-6">
                    <li>Click Invite Now to send the invitation</li>
                    <li>The user will receive an email and appear in your members list once activated</li>
                  </ul>

                  <h3 className="text-[#EA4335] text-2xl font-bold mt-8 mb-4">Removing Users from Your Organization</h3>

                  <p className="text-white/80 text-lg leading-relaxed mb-6">
                    <strong className="text-white">Step 1: Locate the User</strong>
                  </p>
                  <ul className="space-y-3 mb-8 text-white/80 text-lg leading-relaxed list-disc ml-6">
                    <li>Go to the Organization Members section</li>
                    <li>Find the user you want to remove</li>
                  </ul>

                  <p className="text-white/80 text-lg leading-relaxed mb-6">
                    <strong className="text-white">Step 2: Delete the User</strong>
                  </p>
                  <ul className="space-y-3 mb-8 text-white/80 text-lg leading-relaxed list-disc ml-6">
                    <li>Click the trash icon in the Actions column next to the user</li>
                    <li>Confirm the deletion</li>
                    <li>The user&apos;s access will be revoked immediately</li>
                  </ul>

                  <div className="bg-[#4285F4]/10 border border-[#4285F4]/30 rounded-xl p-6 mb-8">
                    <p className="text-white/90 text-lg italic mb-0">
                      <strong className="text-white"><Image src="/images/guide svgs/quick_tip.svg" alt="Tip" width={20} height={20} className="inline-block mr-2" />Quick Tip:</strong> You can also edit user information by clicking the pencil icon in the Actions column to update their designation or role without removing them.
                    </p>
                  </div>
                </div>
