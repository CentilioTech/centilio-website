              ...
              <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-6 lg:p-12">
                ...
                <div className="prose prose-invert max-w-none">
                  <p className="text-white/80 text-lg leading-relaxed mb-6">
                    Centilio Sign provides multiple tools to help administrators monitor and track document activity across their organization. You can view real-time statistics, detailed audit logs, and document statuses all in one place.
                  </p>
