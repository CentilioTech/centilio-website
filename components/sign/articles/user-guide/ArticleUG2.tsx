...
export default function ArticleUG2() {
            ...
            <main className="flex-1">
              <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-6 lg:p-12">
                ...
                <div className="flex items-center gap-2 mb-8 text-sm text-white/50">
                  ...
                  <span>›</span>
                  <span>How do I add recipients to my document?</span>
                </div>
                ...
                <div className="prose prose-invert max-w-none">
                  ...
                  <ol className="space-y-3 mb-8 text-white/80 text-lg leading-relaxed list-decimal list-inside">
                    <li><strong className="text-white">Click the &apos;Add Recipient&apos; button</strong></li>
                    <li><strong className="text-white">Enter the recipient&apos;s name and email address</strong></li>
                    <li>
                      <strong className="text-white">Choose their role:</strong>
                      <ul className="mt-2 ml-6 space-y-2 list-disc">
                        <li><strong className="text-white">Sign:</strong> The recipient needs to sign the document</li>
                        <li><strong className="text-white">Receive a Copy:</strong> The recipient receives a copy without signing</li>
                        <li><strong className="text-white">View Only:</strong> The recipient can view but not sign or download</li>
                      </ul>
                    </li>
