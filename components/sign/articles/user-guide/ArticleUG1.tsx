...
export default function ArticleUG1() {
            ...
            <main className="flex-1">
              <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-6 lg:p-12">
                ...
                <div className="flex items-center gap-2 mb-8 text-sm text-white/50">
                  ...
                  <span>›</span>
                  <span>How do I upload a document for signing?</span>
                </div>
                ...
                <div className="prose prose-invert max-w-none">
                  <p className="text-white/80 text-lg leading-relaxed mb-6">
                    Uploading documents to Centilio Sign is straightforward. You have multiple options to choose from:
                  </p>

                  <ol className="space-y-3 mb-8 text-white/80 text-lg leading-relaxed list-decimal list-inside">
                    <li><strong className="text-white">Navigate to &apos;My Documents&apos; section</strong> from the sidebar</li>
                    <li><strong className="text-white">Click the &apos;Upload&apos; button</strong></li>
                    <li>
                      <strong className="text-white">Choose your upload method:</strong>
                      <ul className="mt-2 ml-6 space-y-2 list-disc">
                        <li>Import from Google Drive</li>
                        <li>Import from Dropbox</li>
                        <li>Import from other cloud storage sources</li>
                        <li>Click &apos;Choose File&apos; to upload from your computer</li>
                      </ul>
                    </li>
                    <li><strong className="text-white">Select your document</strong> and it will be instantly uploaded</li>
                  </ol>
                  ...
                  <div className="my-8 p-6 bg-white/[0.05] border border-white/10 rounded-xl">
                    ...
                    <div className="bg-white/[0.03] border border-[#EA4335]/30 rounded-lg overflow-hidden">
                      <Image
                        src="/images/guide_images/User_Guide/User_Guide_1.png"
                  ...
                  <div className="bg-[#4285F4]/10 border border-[#4285F4]/30 rounded-xl p-6 mb-8">
                    <p className="text-white/90 text-base leading-relaxed">
                      <strong className="text-white">
                        ...
                        Supported Formats:
                      </strong> Centilio Sign supports PDF, DOC, DOCX, and most common document formats. All documents are automatically converted to PDF for signing to ensure consistency.
                    </p>
                  </div>

                  <p className="text-white/80 text-lg leading-relaxed mb-8">
                    Once uploaded, your document will appear in your document library, ready for you to add recipients and signature fields.
                  </p>
                </div>
