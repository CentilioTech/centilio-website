                ...
                <div className="prose prose-invert max-w-none">
                  ...
                  <div className="bg-[#4285F4]/10 border border-[#4285F4]/30 rounded-xl p-6 mb-8">
                    <p className="text-white/90 text-base leading-relaxed">
                      <strong className="text-white">📄 Supported Formats:</strong> Centilio Sign supports PDF, DOC, DOCX, and most common document formats. All documents are automatically converted to PDF for signing to ensure consistency.
                    </p>
                  </div>
