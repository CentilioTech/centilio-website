                ...
                <div className="prose prose-invert max-w-none">
                  ...
                  <div className="bg-[#4285F4]/10 border border-[#4285F4]/30 rounded-xl p-6 mb-8">
                    <p className="text-white/90 text-base leading-relaxed">
                      <strong className="text-white">📊 Real-Time Updates:</strong> The status updates automatically as recipients take action, so you always have the latest information.
                    </p>
                  </div>
                </div>
