                ...
                <div className="prose prose-invert max-w-none">
                  ...
                  <div className="bg-[#4285F4]/10 border border-[#4285F4]/30 rounded-xl p-6 mb-8">
                    <p className="text-white/90 text-base leading-relaxed">
                      <strong className="text-white">✅ Automatic Delivery:</strong> The signed document is automatically sent back to the sender, and you&apos;ll receive a copy via email once all parties have signed.
                    </p>
                  </div>
                </div>
