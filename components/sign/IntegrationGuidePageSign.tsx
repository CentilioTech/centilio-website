...
const integrationGuideArticles = [
  {
    number: 1,
    title: 'How do I connect Google Drive to Centilio Sign?',
    snippet: 'Import documents directly from Google Drive and automatically save signed documents.',
  },
  {
    number: 2,
    title: 'How do I integrate Centilio Sign with my CRM?',
    snippet: 'Connect with Salesforce, HubSpot, and other popular CRM platforms.',
  },
]

export default function IntegrationGuidePageSign() {
  return (
              ...
              <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-6 lg:p-12">
                ...
                <div className="mb-12">
                  ...
                  <p className="text-lg text-white/70 leading-relaxed">
                    Learn how to connect Centilio Sign with your favorite cloud storage services and CRM platforms to streamline your workflow.
                  </p>
                </div>

                {/* Articles List */}
                <div className="space-y-4">
                  {integrationGuideArticles.map((article) => (
                    <Link
                      key={article.number}
                      href={`/sign/guide/integration-guide/article-ig-${article.number}`}
