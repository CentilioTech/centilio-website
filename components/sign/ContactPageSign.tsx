    ...
    <div className="min-h-screen bg-[#0E0F18]">
      ...
      <header className="h-[118px] bg-black flex items-center justify-between px-16 relative z-50">
        ...
        <nav className="flex items-center gap-10">
          <a href="/sign/featurepage-sign" className="text-white text-[14.4px] font-normal hover:opacity-80" style={{ fontFamily: 'var(--font-inter)' }}>
            Features
          </a>
          <a href="/sign/integrations" className="text-white text-[14.4px] font-normal hover:opacity-80" style={{ fontFamily: 'var(--font-inter)' }}>
            Integrations
          </a>
          <a href="/sign/pricing-sign" className="text-white text-[14.4px] font-normal hover:opacity-80" style={{ fontFamily: 'var(--font-inter)' }}>
            Pricing
          </a>
          <a href="/sign/contactpagesign" className="text-white text-[14.4px] font-normal hover:opacity-80" style={{ fontFamily: 'var(--font-inter)' }}>
            Contact Us
          </a>
        </nav>
      </header>
