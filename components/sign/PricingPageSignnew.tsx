            ...
            <div className="mb-4 sm:mb-6 lg:mb-8">
                <div className="flex items-center gap-1 sm:gap-2">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-xs sm:text-sm text-gray-50">Billed monthly</span>
                  </div>
                </div>
              </div>
              {/* Try for free button */}
              <div className="mb-4 sm:mb-6 lg:mb-8">
                {selectedCard === index ? (
                  ...
                  >
                    <button className="w-full bg-white text-[#181A1E] font-semibold py-2 sm:py-3 px-4 sm:px-6 rounded-full hover:bg-opacity-90 transition-all text-sm sm:text-base">
                      Try for free
                    </button>
                  </div>
                ) : (
         ...
         <div className="bg-[#181A1E] border border-[#5A5858] rounded-[16px] sm:rounded-[20px] lg:rounded-[25px] p-4 sm:p-6 md:p-8 lg:p-12 xl:p-16">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-6 lg:gap-8">
            ...
            <div className="flex flex-col items-center gap-3 sm:gap-4">
              ...
              >
                <button className="bg-white text-[#181A1E] font-semibold py-2 sm:py-3 lg:py-4 px-6 sm:px-8 lg:px-12 xl:px-16 rounded-full hover:bg-opacity-90 transition-all whitespace-nowrap text-sm sm:text-base lg:text-lg min-h-[44px] sm:min-h-[48px] lg:min-h-[52px]">
                  Try for free
                </button>
              </div>
            </div>
