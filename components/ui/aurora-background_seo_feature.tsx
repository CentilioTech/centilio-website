        ...
        >
            ...
            <div className="absolute inset-0 overflow-hidden" aria-hidden="true">
                ...
                >
                    ...
                    />
                    <motion.div
                        className="absolute -bottom-1/4 -right-1/4 w-1/2 h-1/2 bg-blue-500 rounded-full filter blur-3xl opacity-40"
                        animate={{
                            x: [50, -50, 50],
                            y: [20, -20, 20],
                            scale: [1, 1.3, 1],
                    ...
                    />
                    <motion.div
                        className="absolute top-1/3 left-1/3 w-1/3 h-1/3 bg-indigo-500 rounded-full filter blur-2xl opacity-30"
                        animate={{
                            x: [0, 30, -30, 0],
                            y: [0, -30, 30, 0],
                            scale: [1, 0.8, 1.1, 1],
