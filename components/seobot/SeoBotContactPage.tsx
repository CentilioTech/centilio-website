                  ...
                  <div className="flex gap-2 xs:gap-3">
                    <div className="relative" ref={dropdownRef}>
                      <button
                        ...
                        className="w-10 xs:w-20 sm:w-24 h-10 xs:h-11 sm:h-12 bg-[#000000] border border-[#5A5858] rounded-lg flex items-center justify-center relative hover:border-[#4285F4] transition-colors gap-1"
                      >
