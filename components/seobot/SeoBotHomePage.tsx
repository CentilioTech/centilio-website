        ...
        <div className="container relative w-full h-full mx-auto px-4 lg:px-0">
          ...
          <div className="hidden lg:block">
            ...
            <div className="absolute" style={{ left: '102px', top: '102px' }}>
              ...
              <Button
                borderRadius="50px"
                className="bg-[#0E0F18] text-white font-semibold hover:bg-[#1a1b24] transition-colors flex items-center justify-center gap-3"
                containerClassName="w-[202px] h-[52px]"
                borderClassName="h-20 w-20 opacity-[0.8] bg-[radial-gradient(var(--sky-500)_60%,transparent_80%)]"
                duration={3500}
              >
          ...
          <div className="lg:hidden py-12 px-4">
            <div className="text-center mb-12">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
                ...
                <button className="w-full sm:w-auto min-w-[200px] h-12 bg-[#0E0F18] text-white font-semibold rounded-full hover:bg-[#1a1b24] transition-colors text-sm px-8 flex items-center justify-center gap-3">
                  <Image
                    src="/images/seobothomepage/first fold/icons/video play Vector.svg"
                    alt="Play"
                    width={16}
