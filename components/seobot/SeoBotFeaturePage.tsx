    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-[#0E0F18] py-8 sm:py-12 md:py-16 lg:py-24 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
          {/* Section Title */}
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-center text-white mb-8 sm:mb-12 md:mb-16 lg:mb-20 pt-8 sm:pt-12 md:pt-16 lg:pt-[60px] pb-6 sm:pb-8 md:pb-12 lg:pb-[60px]" style={{ textShadow: '0px 4px 8px #4285F4' }}>
